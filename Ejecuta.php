...
<?php
echo "<form id='form1' name='form1' method='post' action='actualizar.php' enctype='multipart/form-data'>";
 ...
 echo "Tipo de prueba";
								...
								echo "</div>";
                                     ...
                                     echo "  <div>";
							          ...
							          // echo "  <li><input type='submit' class='special' name='Aceptar' id='Aceptar' value='Actualizar' /></li>";
							          // echo "  <li><input type='reset' class='alt' value='Reiniciar'/></li>";
echo "</ul>";      
echo "</div>";
echo "</div>	";							
							echo "</div>";
